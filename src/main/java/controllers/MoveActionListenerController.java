...
public class MoveActionListenerController implements ActionListener{
	...
	public MoveActionListenerController(JComboBox<String> combo,UserOption userOption) {
		this.combo = combo;
		this.userOption = userOption;
	}
	
	public MoveActionListenerController(JComboBox<String> combo,JPanel spritesPanel) {
		this.combo = combo;
		this.spritesPanel = spritesPanel;
	}
	...
	public void actionPerformed(ActionEvent e) {
       ...
       this.userOption.setMovement(selectedAction.replaceAll(" ","")); 
